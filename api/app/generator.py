...
num_channels = (
    3  # number of channels in the training images. For color images this is 3 (RGB)
)
...
class Generator(torch.nn.Module):
    def __init__(self, num_gpu):
        ...
        self.main = torch.nn.Sequential(
            ...
            torch.nn.ConvTranspose2d(
                in_channels=tconv1,  # 64 x 8 = 512 channels
            ...
            torch.nn.ConvTranspose2d(
                in_channels=tconv2,  # 64 x 4 = 256 channels
            ...
            torch.nn.ConvTranspose2d(
                in_channels=tconv3,  # 64 x 2 = 128 channels
